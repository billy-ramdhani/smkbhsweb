<div class="container">
   ...
   <div class="row mt-3">
      <div class="col">
         <a href="<?= base_url("back/kepegawaian/create") ?>" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Tambah</a>
   ...
   <div class="table-responsive">
      <table id="tableKepegawaian" class="table table-bordered"  cellspacing="0" width="100%">
         ...
         <tr>
            ...
            <td><?= $kg->nama ?></td>
            <td><?= $kg->gelar ?></td>
            <td><?= $kg->jenis_kelamin ?></td>
            <td><?= $kg->email ?></td>
            <td><?= $kg->bidang_pelajaran ?></td>
            <td><?= $kg->jabatan ?></td>
            <td></td>
         </tr>
         <?php endforeach; ?>
...
<!-- Modal -->
<div class="modal fade" id="modalKepegawaian" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
