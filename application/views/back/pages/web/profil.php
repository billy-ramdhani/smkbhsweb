<div class="container">
   ...
   <div class="table-responsive">
      <table id="tableprofil" class="table table-striped table-bordered"  cellspacing="0" width="100%">
         <thead>
         <tr>
            <th>No</th>
            <th>Judul</th>
...
<div class="modal fade" id="modalprofil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         ...
         <h5 class="modal-title" id="modal-title">Edit Profil Sekolah</h5>
         ...
         <div class="modal-body">
            <form action="#" class="form-horizontal" id="form">
               ...
               <div class="form-group row">
                  <label for="judul_profil" class="col-sm-3 col-form-label">Judul</label>
                  <div class="col-sm-9">
                  <input type="text" class="form-control" name="judul_profil">
                  </div>
               </div> 
