        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    <h1 class="display-4 text-white mb-4 animated slideInRight">Mading Sekolah</h1>
                    <nav aria-label="breadcrumb">
                    <p class="text-white mb-4 animated slideInRight">"Kreativitas dan Pendidikan Berkolaborasi, Melangkah Bersama Menuju Masa Depan Terang di SMK BHS."</p>
                    </nav>
                </div>
                <div class="col-lg-6 align-self-end text-center text-lg-end">
                    <img class="img-fluid" src="<?php echo base_url('assets/depan/img/logo_smk_bhs.png')?>" alt="" style="max-height: 300px;">
                </div>
            </div>
        </div>
 </div>
                     ...
                     <?php if (!empty($lastNews)): ?>
                        ...
                        <div class="trending-top mb-30">
                            <div class="trend-top-img">
                                <img src="<?= base_url('assets/img/posting/large/'.$lastNews[0]->photo); ?>" alt="">
                                <div class="trend-top-cap">
                                    <span><?= $lastNews[0]->category_name; ?></span>
                                    <h2><a href="details.html"><?= $lastNews[0]->title; ?></a></h2>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
                    ...
                    <?php foreach ($trending as $tr) :?> 
                        <div class="trand-right-single d-flex">
                            <div class="trand-right-img">
                                <img src="<?= base_url("assets/img/posting/small/$tr->photo") ?>" style="width: 120px; height: 100px;" alt="">
                            </div>
                            <div class="trand-right-cap">
                                <span class="color1"><?= $tr->category_name ?></span>
                                <h4><a href="details.html"><?= $tr->title ?></a></h4>
                            </div>
                        </div>
                    <?php endforeach ?> 
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <?php foreach ($lastNews as $ln) :?> 
                            <div class="single-recent mb-100">
                                <div class="what-img">
                                    <img src="<?= base_url("assets/img/posting/small/$ln->photo") ?>" alt="">
                                </div>
                                <div class="what-cap">
                                    <span class="color1"><?= $ln->category_name ?></span>
                                    <h4><a href="#"><?= $ln->title ?></a></h4>
                                </div>
                            </div>
                        <?php endforeach ?>
                        </div>
                                    ...
                                    <?php foreach($post as $p)  :?>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="single-what-news mb-100">
                                                <div class="what-img">
                                                    <img src="<?= base_url("assets/img/posting/medium/$p->photo") ?>" alt="">
                                                </div>
                                                <div class="what-cap">
      ...
      <div class="container py-5">
         <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
               ...
               <img class="img-fluid" src="<?= base_url("assets/img/posting/medium/$p->photo") ?>" alt="">
               </div>
            </div>
            <div class="col-md-6 col-lg-3">
               <a class="btn btn-sm border rounded-pill text-primary px-3 mb-3" href="<?= base_url("blog/category/$p->slug") ?>"><?= $p->category_name ?></a>
                  <a href="<?= base_url("blog/read/$p->seo_title") ?>" class="float-right"><i class="fa fa-calendar btn btn-sm px-3 mb-3" aria-hidden="true"> <?= mediumdate_indo($p->date) ?></i>
                  </a>
                  ...
                  <a href="<?= base_url("blog/read/$p->seo_title") ?>"><span class="btn btn-primary">Baca</span></a>
            </div>
            <?php endforeach ?>
         </div>
         <!-- Pagination -->
